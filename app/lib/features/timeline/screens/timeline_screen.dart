...
class _TimelineScreenState extends State<TimelineScreen> {
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Título del momento (ej. Primer viaje a la playa)',
                    ),
                  ),
                      ...
                      onPressed: () async {
                        ...
                        if (context.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('¡Recuerdo guardado para siempre! 💖')),
                          );
                        }
                      },
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Toca el botón para guardar su primer momento especial juntos.',
  ...
  Widget _buildMemoryCard(dynamic item) {
